    ...
    <div class="card-body">
        <form action="{{ route('categories.update', $category) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" id="name" class="form-control" value="{{ $category->name }}" placeholder="Ingrese el nombre de la categoría" required>
            ...
            <div class="form-group">
                ...
                <textarea name="description" id="description" class="form-control" placeholder="Ingrese una breve descripción sobre la categoría">{{ $category->description }}</textarea>
            ...
            <div class="text-center">
                ...
                <button type="reset" class="btn btn-warning">
                    <i class="fas fa-undo"></i> Limpiar Cambios
                </button>
...
@section('custom_js')
    <script>
        console.log('Formulario de edición de categoría cargado correctamente!');
    </script>
@endsection
