    ...
    <div class="card-body">
        <form action="{{ route('clients.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="name" id="name" class="form-control form-control-sm" value="{{ old('name') }}" required placeholder="Ej: Juan Pérez">
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="email" name="email" id="email" class="form-control form-control-sm" value="{{ old('email') }}" placeholder="cliente@ejemplo.com">
                </div>
            </div>
    ...
    <script>
        $(document).ready(function() {
            $('#document_type').select2({
                ...
                width: '100%',
                theme: 'bootstrap4' // si estás usando AdminLTE con bootstrap4
            });
        });
    </script>
@endsection
